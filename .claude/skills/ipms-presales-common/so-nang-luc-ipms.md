...
| Chính sách thời hạn lưu trữ & xoá dữ liệu theo Nghị định 13 | PT | Cấu hình theo chính sách của khách, cần phát triển bộ quy tắc lưu trữ | Chưa có retention engine — **không** hứa "tuân thủ NĐ13 sẵn" |
